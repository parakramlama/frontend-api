                ...
                <div className="row">
                    {
                        ...
                        return (
                            ...
                            <div className="card" style={{width:'31rem', marginBottom:'20px', marginTop:'20px', marginLeft:'10px'}}>
                                ...
                                <p>Rs.{product.product_price}
                                </p>

                                <p> {product.product_desc}</p>

                                <p>
                                    <button className="btn btn-danger" onClick={this.sendUserData}>Add to cart</button><Link className="btn btn-primary" to={'/product/single/'+product._id}>View</Link>
                                </p>
