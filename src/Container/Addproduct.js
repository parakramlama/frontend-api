                                ...
                                <form>
                                    <div className="form-row">
                                        <div className="col-lg-9 ml-5">
                                            <p>
                                                Product name<input type="text" name="product_name" value={this.state.product_name} onChange={this.changeGarne} /> 
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-row">
                                        <div className="col-lg-9 ml-5">
                                            <p> 
                                                <input type="file" name="product_img" onChange={this.fileHandler} />
                                            </p> 
